...
export default function Keynote() {
  ...
  return (
    <section className="keynote-strip" ref={ref as React.RefObject<HTMLElement>}>
      <div className="container">
        <motion.div
          className="keynote-grid keynote-grid--centered"
          initial={{ opacity: 0, y: 24 }}
          animate={inView ? { opacity: 1, y: 0 } : {}}
          transition={{ duration: 0.65 }}
        >
          ...
          <div className="keynote-topic-box keynote-topic-box--wide">
            <div className="keynote-topic-tag">
              <svg viewBox="0 0 24 24" width="15" height="15" stroke="currentColor" fill="none" strokeWidth="2.5" style={{ display: 'inline', verticalAlign: 'middle' }}>
                <path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z" />
              </svg>
              Keynote Topic
            </div>
